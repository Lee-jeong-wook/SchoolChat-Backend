...
@Service
class ChatRoomService (private val chatRoomRepository: ChatRoomRepository, private val chatRoomMemberRepository: ChatRoomMemberRepository) {
    ...
    fun checkMember(chatRoomId: Long, memberId: String): Boolean{
        return chatRoomRepository.findChatRoomByMemberId(chatRoomId, memberId) != null;
    }
